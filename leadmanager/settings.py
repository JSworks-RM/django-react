...
SECRET_KEY = '6iz$1z6z@8^ur22=nkx0smdk*udg0di@g)+r@9^75)&a#=xm&f'
...
# Option for authentication classes
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': 
    ('knox.auth.TokenAuthentication',) # THis is a tuple so do not forget to put a coma
}
